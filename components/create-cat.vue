    ...
    <div class="row justify-content-center">
      <div class="center col-md-6">
        ...
        <form class="row justify-content-center">
          ...
          <button class="cat-button" type="button" name="button" @click="createCat">Создать котика</button>
        </form>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    createCat () {
      const cat = [this.name, 'https://img.freepik.com/free-photo/cute-cat.jpg', +this.age, +this.rate, this.favorite, this.description]
      if (cat.includes('')) {
